...
Его корни лежат в стандарте [IEEE754][0], он определяет NaN как специальное значение (на самом деле, 
...
Итак, `NaN`, согласно стандарту [IEEE754][0], не какое-то значение не числового типа, 
